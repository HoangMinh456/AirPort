            ...
            <FlatList
                ...
                renderItem={() => (
                    <>
                            ...
                            <View className="flex gap-y-3 mt-8">
                                ...
                                <View className="flex items-center px-3 w-full">
                                    <FlatList
                                        ...
                                        renderItem={() => (
                                            <View style={{ paddingHorizontal: 4, paddingVertical: 26, borderRadius: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: '#fff' }}>
                        ...
                        {/* Thêm shadow  */}
                        <View style={{ height: height / 12, width: '100%', borderTopLeftRadius: 20, borderTopRightRadius: 20, display: 'flex', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', borderWidth: 1 }}>
                            <View>
                                <Icons typeIcon="Entypo" nameIcon="home" sizeIcon={20} colorIcon="#000000" />
                            </View>
                        </View>
                    </>
                )}
