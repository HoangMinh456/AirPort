    ...
    return (
        <>
            ...
            {/* <View style={styles.container2}>
                ...
                <View className="flex items-center">
                    <Icons typeIcon="FontAwesome" nameIcon="history" sizeIcon={26} colorIcon="#000000" />
                    <CustomText className="text-sm">Lịch sử</CustomText>
                </View>
                <TouchableOpacity onPress={() => navigation.navigate('User')}>
                    <View className="flex items-center">
                        <Icons typeIcon="FontAwesome6" nameIcon="user-large" sizeIcon={26} colorIcon="#000000" />
